...
<section class="content" id="content">
  <div class="box box-success">
    ...
    <?php if (!empty($this->session->flashdata('message'))) {?>
      <h4 class="alert alert-success" style="height:40px; font-size:14px; color:red; margin:50px auto;" >
...
<table id="example1" class="table table-bordered table-striped">
    <thead>
      ...
      <tbody>
        <?php $i = 1; foreach ($this->accountmodel->getMiniUsersById() as $users) { ?>
              <tr>
                <td><?php echo $i++;?></td>
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                      <li class="divider"></li>
                      <li><a href="#" class="editAccountUser" data-id="<?php echo $users['mini_account_id'] ?>" >	<i class="entypo-pencil"></i>Edit	</a></li>
                      <li><a href="#" class="delete" onclick="confirm_delete('<?php echo base_url();?>index.php?users/users_accounts/delete/<?php echo $users['mini_account_id'];?>/<?php echo $users['account_id'];?>');"  >	<i class="entypo-trash"></i>Delete	</a></li>
                      </ul>
                   </div>
                </td>
              </tr>
  ...
  <div class="modal-content">
   ...
   <div class="box-body">
            <div class="form-group">
              ...
              <input type="hidden" class="form-control" id="mini_account_id" name="mini_account_id" >
